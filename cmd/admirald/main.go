...
func main() {
	...
	server := api.NewServer(db, logger, publisher, cfg.AdminToken, cfg.HarborAPIToken, cfg.TokenPepper, cfg.TokenTTLMinutes, cfg.SessionHMACKey, cfg.FleetCallbackKey, secretManager, networkingManager, cfg.TrustedProxies, cfg.DevMode)
