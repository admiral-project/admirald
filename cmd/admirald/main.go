...
func main() {
	...
	server := api.NewServer(db, logger, publisher, cfg.AdminToken, cfg.TokenPepper, cfg.TokenTTLMinutes, cfg.SessionHMACKey, secretManager, networkingManager, cfg.TaskEncryptionKey, cfg.TrustedProxies, cfg.DevMode)
